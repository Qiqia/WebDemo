package WebDemo.litewebapi.util;

public class WebResponseCode {
    public static final Integer WEB_INVALID_NAME = 601;
    public static final Integer WEB_INVALID_PASSWORD = 602;
    public static final Integer WEB_NAME_EXIST = 602;
    public static final Integer WEB_ALTER_NOT_ALLOWED = 603;
    public static final Integer WEB_DELETE_NOT_ALLOWED = 604;
    public static final Integer WEB_INVALID_ACCOUNT = 605;
